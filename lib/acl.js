...
/**
  ...
  @param {String|Array} resource(s) resources to be added.
  @param {Function} Callback called when finished.
*/
Acl.prototype.addResources = function(resources, cb){
  contract(arguments)
    ...
    resources.forEach(function(resource){
        _this.backend.add(transaction, allowsBucket(resource), 'hasResource', true);
    });
